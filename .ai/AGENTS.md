...
- **ADR files** are named `ADR-YYYY-MM-DD.md` and live in
  `features/<feature-name>/`.
- **Implementation plans** are named `implementation-plan.md` and live alongside
  the ADR.
- **Summaries** (`SUMMARY.md`, `IMPLEMENTATION-COMPLETE.md`) are written after a
  feature ships.
